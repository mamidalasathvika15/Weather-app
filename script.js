// --- script.js with all 28 Indian states and districts hardcoded ---
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  stateSelect.addEventListener("change", () => {
    ...
    if (selectedState && weatherData[selectedState]) {
      weatherData[selectedState].forEach(district => {
  ...
  document.getElementById("getWeatherBtn").addEventListener("click", () => {
    ...
    if (state && district) {
      weatherResult.innerHTML = `<h2>Weather in ${district}, ${state}</h2><p>Temperature: 30°C (sample)</p>`;
    } else {
      weatherResult.innerHTML = "<p>Please select both state and district.</p>";
    }
  });
});
